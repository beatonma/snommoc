...
SAMPLE_GOVERNMENT_POSTS = [{"@Id": "661", "Name": "Prime Minister, First Lord of the Treasury and Minister for the Civil Service", "HansardName": "The Prime Minister", "StartDate": "2019-07-24T00:00:00", "EndDate": None, "Note": None, "EndNote": None, "IsJoint": "False", "IsUnpaid": "False", "Email": None, "LayingMinisterName": "The Prime Minister"}, {"@Id": "1128", "Name": "Secretary of State for Foreign and Commonwealth Affairs", "HansardName": "Secretary of State for Foreign and Commonwealth Affairs", "StartDate": "2016-07-13T00:00:00", "EndDate": "2018-07-09T00:00:00", "Note": None, "EndNote": None, "IsJoint": "False", "IsUnpaid": "False", "Email": None, "LayingMinisterName": "Secretary Boris Johnson"}]
...
SAMPLE_PARTY_ASSOCIATIONS = [{"@Id": "17", "Name": "Liberal Democrat", "SubType": None, "StartDate": "1988-03-03T00:00:00", "EndDate": {"@xsi:nil": "true", "@xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance"}, "Note": None, "SitsOppositeSideToParty": "False"}, {"@Id": "32", "Name": "Social Democratic Party", "SubType": None, "StartDate": "1981-03-02T00:00:00", "EndDate": "2013-09-05T00:00:00", "Note": None, "SitsOppositeSideToParty": "False"}, {"@Id": "15", "Name": "Labour", "SubType": "Co-op", "StartDate": "1974-02-28T00:00:00", "EndDate": "1981-03-02T00:00:00", "Note": None, "SitsOppositeSideToParty": "False"}]
...
class MdpUpdateActiveMpsTest(LocalTestCase):
    ...
    def test__update_government_posts(self):
        ...
        self.assertEqual(pm.name, 'Prime Minister, First Lord of the Treasury and Minister for the Civil Service')
        ...
        self.assertEqual(sec_of_state.name, 'Secretary of State for Foreign and Commonwealth Affairs')
        self.assertEqual(sec_of_state.hansard_name, 'Secretary of State for Foreign and Commonwealth Affairs')

        sec_of_state_member = GovernmentPostMember.objects.get(post=sec_of_state)
        self.assertEqual(sec_of_state_member.start, datetime.date(year=2016, month=7, day=13))
        self.assertEqual(sec_of_state_member.end, datetime.date(year=2018, month=7, day=9))
