...
from crawlers.parliamentdotuk.tasks.lda.commons_members import create_members, CommonsMember

log = logging.getLogger(__name__)

EXAMPLE_MEMBER_JSON_ITEMS = [{"_about" : "http://data.parliament.uk/members/172", "additionalName" : {"_value" : "Julie"}
      ...
      , "homePage" : "http://www.dianeabbott.org.uk", "label" : {"_value" : "Biography information for Ms Diane Abbott"}
      , "party" : {"_value" : "Labour"}
      , "twitter" : {"_value" : "https://twitter.com/HackneyAbbott"}
    }
    , {"_about" : "http://data.parliament.uk/members/4212", "additionalName" : {"_value" : "Angela Elspeth Marie"}
      ...
      , "homePage" : "http://www.debbieabrahams.org.uk/", "label" : {"_value" : "Biography information for Debbie Abrahams"}
      , "party" : {"_value" : "Labour"}
      , "twitter" : {"_value" : "https://twitter.com/Debbie_abrahams"}
    }]


# Add context manager functions to CommonsMember for scoped tests
CommonsMember.__enter__ = lambda x: x
CommonsMember.__exit__ = lambda x, a, b, c: None
