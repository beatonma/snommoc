    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Canonical name for this person.", max_length=72
                    ),
                ),
                (
                    "given_name",
                    models.CharField(help_text="First name", max_length=72, null=True),
                ),
                (
                    "family_name",
                    models.CharField(help_text="Last name", max_length=72, null=True),
                ),
                (
                    "additional_name",
                    models.CharField(
                        blank=True, help_text="Middle name(s)", max_length=72, null=True
                    ),
                ),
                (
                    "gender",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "constituency_type",
                    models.CharField(
                        choices=[("county", "County"), ("borough", "Borough")],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hansard",
                    models.CharField(
                        blank=True, help_text="Hansard ID", max_length=16, null=True
                    ),
                ),
                (
                    "house",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "primary_color",
                    models.CharField(help_text="Hex color code", max_length=6),
                ),
                (
                    "accent_color",
                    models.CharField(help_text="Hex color code", max_length=6),
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                help_text="ID used on theyworkforyou.com", null=True, unique=True
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AlterField(
            ...
            name="family_name",
            field=models.CharField(
                blank=True, help_text="Last name", max_length=72, null=True
            ),
        ),
        migrations.AlterField(
            model_name="person",
            name="given_name",
            field=models.CharField(
                blank=True, help_text="First name", max_length=72, null=True
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="repository.parliamentarypost",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="repository.declaredinterestcategory",
            ),
        ),
        migrations.AddField(
            model_name="declaredinterest",
        ...
        migrations.AddField(
            ...
            name="election",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="repository.election"
            ),
        ),
        migrations.AddField(
            model_name="contestedelection",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True, help_text="Middle name(s)", max_length=128, null=True
            ),
        ),
        migrations.AlterField(
            model_name="person",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("name", "mp", "election"), name="unique_election_result"
            ),
        ),
        ...
        migrations.AddConstraint(
            model_name="unlinkedconstituency",
            constraint=models.UniqueConstraint(
                fields=("name", "person", "election"), name="unique_election_result"
            ),
        ),
        migrations.AlterField(
            model_name="declaredinterest",
